...
export default class MoscowFood extends Component {
  ...
  render() {
    ...
    <Text style = {styles.titleText}> Fancy clubs </Text>
    <Text style = {styles.titleText}>Kot Shredingera https://www.kotbar.ru/angl Bolshaya Dmitrovka St., 32, Moscow 115487, Russia </Text>
